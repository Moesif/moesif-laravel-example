...
include('SendCurlTaskConsumer.php');

// use App\Http\Middleware\Moesif\SendTaskConsumer;
// use App\Http\Middleware\Moesif\SendCurlTaskConsumer;
// require_once(dirname(__FILE__) . "/BaseClass.php");
// require_once(dirname(__FILE__) . "/SendTaskConsumer.php");
// require_once(dirname(__FILE__) . "/SendCurlTaskConsumer.php");
